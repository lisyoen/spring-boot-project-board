...
class ArticleControllerTest {
    ...
    @DisplayName("[view][GET] 게시글 리스트(게시판) 페이지 - 검색어 포함 호출")
    @Test
    ...
    @DisplayName("[view][GET] 게시글 페이지 - 인증이 없으면 로그인 페이지로 이동")
    @Test
    void givenNothing_whenRequestingArticleView_thenRedirectToLoginView() throws Exception {
        // Given
        long articleId = 1L;
    ...
    @DisplayName("[view][GET] 게시글 해시태그 검색 페이지 - 정상 호출 : 해시태그 입력 X")
    @Test
    ...
    @WithUserDetails(value = "junoTest", setupBefore = TestExecutionEvent.TEST_EXECUTION)
    ...
    @DisplayName("[view][GET] 게시글 수정 페이지 - 인증이 없으면 로그인 페이지로 이동")
    @Test
    void givenNothing_whenRequesting_thenRedirectToLoginView() throws Exception {
        // Given
        long articleId = 1L;
