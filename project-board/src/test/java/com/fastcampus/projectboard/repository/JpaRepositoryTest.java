...
class JpaRepositoryTest {
    ...
    void givenTestData_whenInserting_thenWorksFine() {
        ...
        UserAccount userAccount = userAccountRepository.save(UserAccount.of("newJuno", "pw", null, null, null));
        Article article = articleRepository.save(Article.of(userAccount, "new article", "content"));
    ...
    void givenNothing_whenQueryingHashtags_thenReturnsHashtagNames() {
        ...
        // When
        List<String> hashtagNames = hashtagRepository.findByHashtagNames();
