...
class ArticleServiceTest {
    ...
    void givenNonexistentArticleId_whenSearchingArticleWithComments_thenThrowsException() {
        ...
        assertThat(t)
                ...
                .hasMessage("게시글이 존재하지 않음 - articleId: " + articleId);
    ...
    @DisplayName("게시글 수를 조회 시, 게시글 수를 반환")
    @Test
    ...
    void givenNothing_whenCalling_thenReturnsHashtags() {
        ...
        given(hashtagRepository.findByHashtagNames()).willReturn(expectedHashtags);
        ...
        then(hashtagRepository).should().findByHashtagNames();
    }
