...
class PaginationServiceTest {
    ...
    @DisplayName("현재 페이지와 총 페이지 수를 주면 페이징 바 리스트를 반환")
    ...
    private static Stream<Arguments> givenCurrentPageNumberAndTotalPages_whenCalculating_thenReturnsPaginationBarNumbers() {
        return Stream.of(
    ...
    void givenNothing_whenCalling_thenReturnsCurrentBarLength() {
        ...
        //then
        assertThat(barLength).isEqualTo(expected);
    }
}